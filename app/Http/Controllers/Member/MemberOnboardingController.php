...
class MemberOnboardingController extends Controller
{
    public function edit(): View
    {
        ...
        return view('member.onboarding.edit', [
            ...
            'countryOptions' => CountryCallingCodes::countryOptions($callingCodes),
        ]);
    }
    ...
    public function update(Request $request): RedirectResponse
    {
        ...
        $validated = $request->validate([
            ...
            'emergency_contact_phone_country' => ['nullable', 'required_with:emergency_contact_phone_number', 'string', Rule::in(array_keys($phonePrefixLookup))],
        ...
        $validated['phone'] = $this->normalizePhone($validated, $phonePrefixLookup);
    ...
    private function normalizePhone(
        ...
        $countryCode = $phonePrefixLookup[$country]['prefix'] ?? '';
