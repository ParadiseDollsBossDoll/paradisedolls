...
<label for="is_published" class="flex items-start gap-3 rounded-xl border border-white/[0.06] bg-white/[0.03] p-4">
    <input id="is_published" name="is_published" type="checkbox" value="1" class="mt-1 rounded border-white/15 bg-white/5 text-[#EEB4C3] focus:ring-[#EEB4C3]" @checked(old('is_published', $testimonial?->is_published ?? false))>
    <span>
