...
<x-admin-layout>
    ...
    >
        ...
        <div class="flex items-center gap-2 text-[0.68rem] text-boss-ivory/30">
            <span class="rounded-full px-2.5 py-0.5" x-bind:style="`background-color: ${platformColor}20; color: ${platformColor};`">1 Course Details</span>
            <span class="text-boss-ivory/15">-></span>
            <span class="rounded-full px-2.5 py-0.5" x-bind:style="`background-color: ${platformColor}20; color: ${platformColor};`">2 Course Materials</span>
            <span class="text-boss-ivory/15">-></span>
            ...
            <section class="overflow-hidden rounded-2xl border border-white/[0.06] bg-[#0E0E1A]">
                ...
                <div class="space-y-4 p-5">
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="4" class="pd-input mt-2" required placeholder="{{ __('Describe what models will learn') }}">{{ old('description', $course->description) }}</textarea>
