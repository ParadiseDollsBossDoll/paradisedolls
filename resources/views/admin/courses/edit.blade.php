...
<x-admin-layout>
    ...
    >
        ...
        <div x-show="draftAvailable" x-cloak
            class="flex flex-wrap items-center justify-between gap-3 rounded-xl border border-[#EEB4C3]/25 bg-[#EEB4C3]/[0.07] px-4 py-3">
            <div>
                <p class="text-[0.82rem] font-medium text-[#EEB4C3]">{{ __('Unsaved draft found') }}</p>
            ...
            <div class="flex gap-2">
                <button type="button" @click="restoreDraft()"
                    class="rounded-lg border border-[#EEB4C3]/30 bg-[#EEB4C3]/15 px-3 py-1.5 text-[0.72rem] text-[#EEB4C3] transition-colors hover:bg-[#EEB4C3]/20">
                    {{ __('Restore draft') }}
                </button>
        ...
        <div x-show="autosaveStatusLabel" x-cloak
            ...
            :class="{
                ...
                'border border-[#EEB4C3]/15 bg-[#EEB4C3]/[0.05] text-[#EEB4C3]/70': autosave.status === 'saving',
                    ...
                    <div class="grid gap-6 lg:grid-cols-2 lg:items-start">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <div class="mt-3 flex flex-wrap items-center gap-3">
                                    ...
                                    <input id="platform_color" type="text" x-model="platformColor" class="w-24 rounded-lg border border-white/10 bg-white/[0.06] px-2.5 py-1.5 font-mono text-[0.72rem] text-boss-ivory focus:border-[#EEB4C3]/50 focus:outline-none" placeholder="#EEB4C3">
                                </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <textarea id="course_access_requirements" name="course_access_requirements" rows="4" class="pd-input mt-2" placeholder="{{ __('Tell models what they must submit or complete before Kayla unlocks this course. One requirement per line works well.') }}">{{ old('course_access_requirements', $course->course_access_requirements) }}</textarea>
                            ...
                            <div class="rounded-xl border border-[#EEB4C3]/12 bg-[#EEB4C3]/[0.04] p-4">
                                ...
                                <div class="mt-4 grid gap-3 sm:grid-cols-2">
                                    <div>
                                        ...
                                        <textarea id="access_registration_instructions" name="access_registration_instructions" rows="3" class="pd-input mt-2" placeholder="{{ __('Example: Register on the website and send the account email/username Kayla asks for.') }}">{{ old('access_registration_instructions', $course->access_registration_instructions) }}</textarea>
                                    ...
                                    <div>
                                        ...
                                        <textarea id="access_callback_instructions" name="access_callback_instructions" rows="3" class="pd-input mt-2" placeholder="{{ __('Example: Wait for Kayla to call/video call and explain the QR verification flow.') }}">{{ old('access_callback_instructions', $course->access_callback_instructions) }}</textarea>
                                    ...
                                    <div>
                                        ...
                                        <textarea id="access_onboarding_instructions" name="access_onboarding_instructions" rows="3" class="pd-input mt-2" placeholder="{{ __('Example: Follow Kayla\'s setup checklist before submitting final verification.') }}">{{ old('access_onboarding_instructions', $course->access_onboarding_instructions) }}</textarea>
                                    ...
                                    <div>
                                        ...
                                        <textarea id="access_verification_instructions" name="access_verification_instructions" rows="3" class="pd-input mt-2" placeholder="{{ __('Example: Submit QR codes/screenshots quickly because codes can expire after a few minutes.') }}">{{ old('access_verification_instructions', $course->access_verification_instructions) }}</textarea>
                            ...
                            <div class="grid gap-4 sm:grid-cols-[1fr_160px] sm:items-end">
                                <label for="is_published" class="flex items-start gap-2.5 rounded-lg border border-white/[0.06] bg-white/[0.03] p-3">
                                    ...
                                    <input id="is_published" name="is_published" type="checkbox" value="1" class="mt-0.5 rounded border-white/15 bg-white/5 text-[#EEB4C3] focus:ring-[#EEB4C3]" @checked(old('is_published', $course->is_published))>
                                    <span>
                                ...
                                <div class="flex items-center gap-1.5">
                                    <template x-if="lesson.id">
                                        <a x-bind:href="lessonPreviewUrl(lesson)"
                                            class="rounded border border-[#EEB4C3]/15 bg-[#EEB4C3]/[0.06] px-2 py-1 text-[0.63rem] text-[#EEB4C3] transition-colors hover:bg-[#EEB4C3]/10">
                                            {{ __('Preview') }}
                                        </a>
                                    </template>
                                    <button type="button"
