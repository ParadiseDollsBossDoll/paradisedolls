...
>
    @if ($outlineUrl)
        <div x-show="!fileLabel" class="mb-2 rounded-lg border border-white/[0.06] bg-[#08080f] px-3 py-2">
            ...
            <a href="{{ $outlineUrl }}" target="_blank" rel="noopener noreferrer" class="mt-1 block truncate text-[0.78rem] text-[#EEB4C3] hover:text-[#F3C3CF]">
                {{ $outlineFileName }}
            </a>
        </div>
    @endif
    ...
    <label
        ...
        :class="drag ? 'border-[#EEB4C3]/70 bg-[#EEB4C3]/[0.07]' : (fileLabel ? 'border-[#EEB4C3]/30 bg-[#EEB4C3]/[0.03]' : 'border-white/[0.10] bg-white/[0.025] hover:border-[#EEB4C3]/30 hover:bg-white/[0.035]')"
    >
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"
            class="h-6 w-6 transition-colors duration-200"
            :class="drag ? 'text-[#EEB4C3]/80' : (fileLabel ? 'text-[#EEB4C3]/50' : 'text-boss-ivory/20')">
            <path d="M12 15V3m0 0l-4 4m4-4 4 4"/>
            <path d="M3 17v2a2 2 0 002 2h14a2 2 0 002-2v-2"/>
        </svg>
        <span class="text-[0.58rem] font-semibold uppercase tracking-[0.15em] transition-colors duration-200" :class="drag ? 'text-[#EEB4C3]' : (fileLabel ? 'text-[#EEB4C3]/70' : 'text-[#EEB4C3]/55')">
