    ...
    <section class="bg-white py-24">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="grid gap-16 lg:grid-cols-[1fr_1fr] lg:items-start">
                <div>
                    <p class="mb-4 text-[0.7rem] uppercase tracking-[0.3em] text-boss-rose">{{ __('Why Paradise Dolls Exists') }}</p>
    ...
    <section class="bg-boss-cream py-24">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="grid gap-14 lg:grid-cols-[0.95fr_1.05fr] lg:items-start">
                <div>
                    <p class="mb-4 text-[0.7rem] uppercase tracking-[0.3em] text-boss-rose">{{ __('My Story') }}</p>
                    ...
                    <div class="mt-10 space-y-6 text-[0.95rem] leading-relaxed text-boss-dark/70">
                        ...
                        <p>
                            ...
                            <a href="https://playboy.co.za/2026/04/30/sets-the-tone/" target="_blank" rel="noopener noreferrer" class="font-medium text-boss-rose underline decoration-boss-rose/40 underline-offset-4 transition-colors hover:text-boss-dark">{{ __('Playboy feature') }}</a>
                        </p>
    ...
    <section class="bg-white py-24">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="mb-14 text-center">
                <p class="mb-4 text-[0.7rem] uppercase tracking-[0.3em] text-boss-rose">{{ __('The Journey') }}</p>
            ...
            <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-5">
                @foreach ([
                    ...
                    <div class="border border-boss-pink/40 bg-boss-muted p-6">
                        <p class="font-display text-[2rem] leading-none text-boss-rose">{{ $t[0] }}</p>
